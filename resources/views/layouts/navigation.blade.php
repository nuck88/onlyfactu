        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('conceptos')" :active="request()->routeIs('conceptos')">
                        {{ __('Concepto') }}
                    </x-nav-link>

                    <x-nav-link :href="route('comparador')" :active="request()->routeIs('comparador')">
                        {{ __('Comparador de precios') }}
                    </x-nav-link>
                </div>
            </div>
